...
coordsLibresParaPlayer game@(ShogiGame activo listaFichas) player = filter (esCoordLibreParaPlayer) todasLasCoordenadas
  where esCoordLibreParaPlayer = (\coord -> ((getCoordenada coord listaFichas)==Nothing)&&(enCampoPropio coord player))

todoBiencoordsLibresParaPlayer = (coordsLibresParaPlayer beginning Sente)==[Coordenada 1 2,Coordenada 1 4,Coordenada 1 5,Coordenada 1 6,Coordenada 2 4,Coordenada 2 5,Coordenada 2 6,Coordenada 3 2,Coordenada 3 4,Coordenada 3 5,Coordenada 3 6,Coordenada 4 2,Coordenada 4 4,Coordenada 4 5,Coordenada 4 6,Coordenada 5 2,Coordenada 5 4,Coordenada 5 5,Coordenada 5 6,Coordenada 6 2,Coordenada 6 4,Coordenada 6 5,Coordenada 6 6,Coordenada 7 2,Coordenada 7 4,Coordenada 7 5,Coordenada 7 6,Coordenada 8 4,Coordenada 8 5,Coordenada 8 6,Coordenada 9 2,Coordenada 9 4,Coordenada 9 5,Coordenada 9 6]
