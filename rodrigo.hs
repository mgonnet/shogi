...
caso3 = (isFinished (ShogiGame (Just Sente) [(Rey, (Coordenada 3 2), Sente), (Caballo, (Coordenada 3 3), Gote)]))==True
--Tengo un rey y un caballo
caso4 = (isFinished (ShogiGame (Just Sente) [(Rey, (Coordenada 3 2), Sente)]))==True
--Tengo solo un rey
